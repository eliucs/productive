...
const SUCCESS_DATA_LOADED = 'Success: ProductiveData loaded.';
const SUCCESS_NEW_DATA_LOADED = 'Success: New ProductiveData loaded.';
const SUCCESS_SEARCH = 'Search: ';
const SUCCESS_NEW_LINK_ID = 'New ID Added: ';
const SUCCESS_NEW_LINK_URL = 'New URL Added: ';
const SUCCESS_NEW_LINK_TITLE = 'New Title Added: ';
const SUCCESS_NEW_LINK_DESC = 'New Description Added: ';
const SUCCESS_DELETE_LINK = 'Deleted: ';
